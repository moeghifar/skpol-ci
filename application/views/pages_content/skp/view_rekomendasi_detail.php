            ...
            <div class="panel-body">
				<div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <p class="control-label" style="text-align: left;">
                            <?=$rekomendasi[0]['nama_upi']?>
                            <a class="btn btn-xs btn-primary info-lihat-detail" href="<?php echo base_url('upi/view_detail/'.$rekomendasi[0]['idtbl_upi']);?>"><i class="ico ico-eye-open"></i> Lihat Info UPI</a>
                        </p>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9">
                        <p class="control-label" style="text-align: left;">
                            <?php 
                                if($rekomendasi[0]['realisasiproduksi_skp'] > 0) {
                                    echo number_format($rekomendasi[0]['realisasiproduksi_skp'],'0',',','.');
                                } else {
                                    echo "0";
                                }
                            ?> Kg/Tahun
